package BookCode.chapter_3_binarytreeproblem;
...
public class Problem_19_TarjanAndDisjointSetsForLCA {
  ...
  public static void setQueriesAndSetEasyAnswers(Query[] ques, Node[] ans, HashMap<Node, LinkedList<Node>> queryMap,
  ...
  public static void setAnswers(Node head, Node[] ans, HashMap<Node, LinkedList<Node>> queryMap,
